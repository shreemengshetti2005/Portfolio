          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              <div className="blink">
                ...
                <span className="mr-2 text-white">ComputerEngineer</span>
              ...
              <div>
                ...
                <span className="text-gray-400">{`"`}</span>
                <span className="text-amber-300">Shree Mengshetti</span>
                <span className="text-gray-400">{`"`}</span>
              </div>
              <div>
                <span className="ml-8 lg:ml-16 mr-2 text-cyan-400">self</span>
              ...
              <div>
                <span className="ml-8 lg:ml-16 mr-2 text-cyan-400">self</span>
                <span className="mr-2 text-white">.problem_solving</span>
                <span className="mr-2 text-pink-500">=</span>
                <span className="text-orange-400">True</span>
              </div>
              <div>
                <span className="ml-8 lg:ml-16 mr-2 text-cyan-400">self</span>
                <span className="mr-2 text-white">.fast_learner</span>
                <span className="mr-2 text-pink-500">=</span>
                <span className="text-orange-400">True</span>
              </div>
              <div>
